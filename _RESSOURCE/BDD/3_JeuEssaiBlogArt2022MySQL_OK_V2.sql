...
//
// nom script : JeuEssaiBlogArt2022MySQL_OK.sql
//
//
...
--
-- Une seule occurrence dans la table user => Super admin
-- Del impossible, Seul le password est modifiable
-- Prévoir le pass protégé (hash)
*/
--
INSERT INTO user (pseudoUser, passUser, nomUser, prenomUser, eMailUser, idStat)
VALUES
  ('admin', "admin", "Star", "Joe", "JoeStar@free.fr", 1);
--
-- --------------------------------------------------------------------
...
*/
--
INSERT INTO membre (numMemb, prenomMemb, nomMemb, pseudoMemb, passMemb, eMailMemb, dtCreaMemb, accordMemb, idStat)
VALUES
  (1, "Jean", "Dupont", 'Phil09', "Ut!D5?h0", "Phil09@me.com", '2020-01-09 10:13:43', true, 1);

INSERT INTO membre (numMemb, prenomMemb, nomMemb, pseudoMemb, passMemb, eMailMemb, dtCreaMemb, accordMemb, idStat)
VALUES
  (2, "Julie", "La Rousse", 'juju1989', "G54;Q22mi5", "julie@gmail.com", '2020-03-15 14:33:23', true, 3);

INSERT INTO membre (numMemb, prenomMemb, nomMemb, pseudoMemb, passMemb, eMailMemb, dtCreaMemb, accordMemb, idStat)
VALUES
  (3, "David", "Bowie", 'dav33B', "kp09,1K4!", "david.bowie@gmail.com", '2020-07-19 13:13:13', true, 4);

INSERT INTO membre (numMemb, prenomMemb, nomMemb, pseudoMemb, passMemb, eMailMemb, dtCreaMemb, accordMemb, idStat)
VALUES
  (4, "Phil", "Collins", 'cols2P', "mq3j4;6GH", "phil.collins@me.com", '2020-11-04 17:39:09', true, 2);

INSERT INTO membre (numMemb, prenomMemb, nomMemb, pseudoMemb, passMemb, eMailMemb, dtCreaMemb, accordMemb, idStat)
VALUES
  (5, "Prince", "Rogers Nelson dit PRINCE", 'Rogers222', "frI3!Px;21", "prince@gmail.com", '2020-12-14 13:24:23', true, 5);
--
-- --------------------------------------------------------------------
...
*/
--
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(001, 01, '2020-11-09 10:13:43', "Trop cool comme article", true, '2020-11-09 17:49:29', null, false, 01);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(002, 01, '2020-11-02 13:18:42', "Trop cool comme article", true, '2020-11-03 08:23:19', null, false, 02);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(003, 01, '2020-11-04 16:21:12', "Trop cool comme article", true, '2020-11-05 10:42:42', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(004, 01, '2020-11-05 03:15:38', "Trop cool comme article", true, '2020-11-05 23:50:13', null, false, 01);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(005, 01, '2020-11-06 21:16:36', "Trop cool comme article", true, '2020-11-10 11:39:03', null, false, 04);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(006, 01, '2020-11-06 11:20:31', "Trop cool comme article", true, '2020-11-06 18:41:54', null, false, 05);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(007, 01, '2020-11-08 08:41:12', "Trop cool comme article", true, '2020-11-10 20:53:32', null, false, 05);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
  (008, 01, '2020-11-18 08:41:12', "De la daube cet article", false, '2020-11-19 14:51:26', "Trop insultant", false, 01);
--
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(001, 02, '2020-11-09 18:24:21', "Trop cool comme article", true, '2020-11-10 08:10:00', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(002, 02, '2020-11-02 16:29:16', "Trop cool comme article", true, '2020-11-03 19:43:12', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(003, 02, '2020-11-04 08:16:44', "Trop cool comme article", true, '2020-11-04 15:41:23', null, false, 02);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(004, 02, '2020-11-05 14:27:39', "Trop cool comme article", true, '2020-11-05 19:19:29', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(005, 02, '2020-11-06 06:31:42', "Trop cool comme article", true, '2020-11-06 11:25:22', null, false, 01);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(006, 02, '2020-11-06 23:50:27', "Trop cool comme article", true, '2020-11-07 09:21:24', null, false, 05);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(007, 02, '2020-11-08 10:37:23', "Trop pourri comme article", false, '2020-11-09 13:43:32', "Manque de bienveillance", false, 02);
--
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(001, 03, '2020-11-09 15:31:17', "Trop cool comme article", true, '2020-11-10 09:28:02', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(002, 03, '2020-12-15 08:31:23', "Trop cool comme article", true, '2020-12-16 10:11:44', null, false, 02);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(003, 03, '2020-12-19 06:28:00', "Trop cool comme article", true, '2020-12-19 13:08:40', null, false, 05);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(004, 03, '2020-12-28 07:30:21', "Trop cool comme article", true, '2020-12-28 11:45:27', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(005, 03, '2020-12-29 17:31:38', "Trop cool comme article", true, '2020-12-29 21:33:48', null, false, 01);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(006, 03, '2020-12-29 09:31:27', "Pourri trop, trop comme article", false, '2020-12-29 14:15:57', "Trop insultant", false, 04);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(007, 03, '2020-12-02 16:33:41', "Trop cool comme article", true, '2020-12-04 10:24:34', null, false, 03);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(008, 03, '2020-12-03 12:41:47', "De la daube cet article", false, '2020-12-03 16:39:23', "Trop insultant", false, 02);
INSERT INTO comment (numSeqCom, numArt, dtCreCom, libCom, attModOK, dtModCom, notifComKOAff, delLogiq, numMemb)
VALUES
	(009, 03, '2020-12-04 10:33:42', "Trop cool comme article", true, '2020-12-05 10:33:42', null, false, 05);
--
-- --------------------------------------------------------------------
