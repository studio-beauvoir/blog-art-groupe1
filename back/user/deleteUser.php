...
?>
    ...
    >
        ...
        <div class="field">
            ...
            <br>
            <label><input type="checkbox" onclick="togglePassword('myInput1')"><i>Afficher mot de passe</i></label>
        </div>
        ...
        <div class="field">
            ...
            <br>
            <label><input type="checkbox" onclick="togglePassword('myInput2')"><i>Afficher mot de passe</i></label>
            &nbsp;&nbsp;
